...
export function TableRowFieldWrapper(props) {
    ...
    return _jsxs(Fragment, { children: [_jsxs("div", __assign({ className: 'py-2 flex __wbox-tailwind-table-layout-field-wrapper' }, { children: [_jsx("div", __assign({ "data-testid": DATA_TEST_ID_TABLE_ROW_LABEL_WRAPPER, className: "flex items-".concat(labelAlignment) }, { children: _jsx("label", __assign({ "data-testid": DATA_TEST_ID_TABLE_ROW_LABEL, className: labelClassName, style: { width: labelWidth } }, { children: props.label })) })), _jsx("div", { "data-testid": DATA_TEST_ID_TABLE_ROW_FIELD_WRAPPER_SPACE, className: 'inline-block', style: { width: spaceWidth } }), props.field] })), props.displayDivider &&
                _jsx("div", __assign({ "data-testid": DATA_TEST_ID_TABLE_ROW_DIVIDER, className: 'py-2' }, { children: _jsx("hr", {}) }))] });
}
