var generalNormalClassName = "mt-0 dark:text-white bg-transparent block w-full px-0.5 border-0 border-b-2 border-gray-200 dark:border-gray-600 focus:ring-0 focus:border-black dark:focus:border-white";
var generalErrorClassName = "mt-0 text-error-500 bg-transparent block w-full px-0.5 border-0 border-b-2 border-gray-200 dark:border-gray-600 focus:ring-0 focus:border-black dark:focus:border-white";
