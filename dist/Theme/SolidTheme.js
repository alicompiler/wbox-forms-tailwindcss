var generalNormalClassName = "mt-1 block w-full rounded-md bg-gray-200 border-transparent focus:border-gray-500 focus:ring-0";
var generalErrorClassName = "mt-1 block w-full rounded-md bg-error-200 border-transparent focus:border-gray-500 focus:ring-0";
